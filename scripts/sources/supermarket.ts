...
export const supermarketStaplesProvider: CatalogSourceProvider = {
  ...
  async fetchPrices(): Promise<NormalizedPriceUpdate[]> {
    ...
    return [
      ...
      {
        productId: 'leche-mes',
        productName: 'Leche entera (12 litros / mes)',
        shortName: 'Leche (12 L)',
        category: 'dia-a-dia',
        countryCode: 'ES',
        value: 11.40,
        date,
        note: 'Pack de 12 litros de leche entera de vaca (0,95 €/L). Consumo mensual orientativo de un hogar.',
        source: 'Índice de Supermercados / Open Food Facts',
        origin: 'local',
        visible: true,
      },
      {
        productId: 'huevos-docena',
        productName: 'Docena de huevos camperos (L)',
        shortName: 'Docena de huevos',
        category: 'dia-a-dia',
        countryCode: 'ES',
        value: 2.75,
        date,
        note: 'Docena de huevos camperos de gallinas criadas en suelo (Categoría L).',
        source: 'Índice de Supermercados / Open Food Facts',
        origin: 'local',
        visible: true,
      },
